...
public class QualityCubeReport {
	...
	private final static String OPTION_SK_AIPVERSION = "ver";	
	...
	public static void printHelp(final Options options, final int printedRowWidth, final String header,
		...
		final String commandLineSyntax = "-lookupExtensionsDetails -lookupQualityRuleDetails -AIPVersion 8.2.5_1598";
